...
abstract class BaseItemAnimator : SimpleItemAnimator() {
    ...
    override fun recordPostLayoutInformation(
        ...
        val recordPostLayoutInformation = super.recordPostLayoutInformation(state, viewHolder)
    ...
    override fun recordPreLayoutInformation(
        ...
        val recordPreLayoutInformation = super.recordPreLayoutInformation(state, viewHolder, changeFlags, payloads)
